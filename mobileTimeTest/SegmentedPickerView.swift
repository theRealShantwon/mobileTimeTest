...
//  SegmentedPickerView
//
//  Created by macOS Big Sur on 8/1/21.
//
...
struct SegmentedPicker: View {
    ...
    private static let BackgroundColor: Color = Color(.secondarySystemBackground).opacity(0.9)
...
//        Group {
//            SegmentedPicker(items: ["Map", "Satellite"], selection: .constant(0))
//                .padding()
//            SegmentedPicker(items: ["Map", "Satellite"], selection: .constant(1))
//                .padding()
//        }
//    }
//}
